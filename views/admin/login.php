...
<head>
    ...
    <link rel="stylesheet" href="/template/css/styleNew.css">
</head>
<body>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <br />
            <h1 class="text-center login-title">Вход в Админ-панель</h1>
            <div class="account-wall">
                <form class="form-signin" action="/sign_in" method="post">
                    <input type="text" class="form-control" placeholder="Имя пользователя" name="userName" required autofocus>
